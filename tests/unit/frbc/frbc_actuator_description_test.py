...
class FRBCActuatorDescriptionTest(TestCase):
    def test__from_json__happy_path(self):
        ...
        # Act
        frbc_actuator_description: FRBCActuatorDescription = FRBCActuatorDescription.from_json(json_str)

        # Assert
        expected_timer = Timer(id=uuid.UUID("3bdec10b-be3b-4ba9-afa0-c4a0632ffed6"),
                               diagnostic_label='timer1',
        ...
        self.assertEqual(frbc_actuator_description.diagnostic_label, "some name of actuator")
        self.assertEqual(frbc_actuator_description.id, uuid.UUID("3bdec96b-be3b-4ba9-afa0-c4a0632dded5"))
        self.assertEqual(frbc_actuator_description.supported_commodities, [Commodity.HEAT, Commodity.ELECTRICITY])
        self.assertEqual(frbc_actuator_description.operation_modes, [expected_operation_mode])
    ...
    def test__to_json__happy_path(self):
        # Arrange
        timer = Timer(id=uuid.UUID("3bdec10b-be3b-4ba9-afa0-c4a0632ffed6"),
                      diagnostic_label='timer1',
                      duration=Duration.from_timedelta(timedelta(seconds=2.3)))
