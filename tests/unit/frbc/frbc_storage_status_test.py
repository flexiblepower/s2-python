        ...
        json_str = """
{
    ...
    "present_fill_level": 2443.939298819414
        ...
        # Assert
        self.assertEqual(frbc_storage_status.message_id, uuid.UUID("6bad8186-9ebf-4647-ac45-1c6856511a2f"))
    ...
    def test__to_json__happy_path_full(self):
        # Arrange
        frbc_storage_status = FRBCStorageStatus(message_id=uuid.UUID("6bad8186-9ebf-4647-ac45-1c6856511a2f"),
                                                message_type="FRBC.StorageStatus", present_fill_level=2443.939298819414)
