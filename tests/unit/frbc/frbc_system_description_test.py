        ...
        json_str = """
{
    ...
    "valid_from": "2020-10-07T06:30:55+00:00"
}
        """
        ...
        self.assertEqual(frbc_system_description.actuators, [
            FRBCActuatorDescription(diagnostic_label="some-test-string2728",
                                    id=uuid.UUID("a1061148-f19e-4b1b-8fe3-b506583ce61e"), operation_modes=[
                    FRBCOperationMode(abnormal_condition_only=False, diagnostic_label="some-test-string2930", elements=[
                        FRBCOperationModeElement(fill_level_range=NumberRange(end_of_range=36932.65171036228,
                                                                              start_of_range=12649.272766336762),
                                                 fill_rate=NumberRange(end_of_range=34553.16163528188,
                                                                       start_of_range=14377.963894945604),
                                                 power_ranges=[
                                                     PowerRange(commodity_quantity=CommodityQuantity.ELECTRIC_POWER_L1,
                                                                end_of_range=46924.65023353163,
                                                                start_of_range=11888.235871902496)],
                                                 running_costs=NumberRange(end_of_range=42897.60731684277,
                                                                           start_of_range=33997.56376994998))],
                                      id=uuid.UUID("2795136c-eb30-4f8a-bdaa-61feba1e71b6"))],
                                    supported_commodities=[Commodity.ELECTRICITY], timers=[
                    Timer(diagnostic_label="some-test-string4315",
                          duration=Duration.from_timedelta(timedelta(milliseconds=14099)),
                          id=uuid.UUID("e1ff9e58-935b-4765-92e3-5e7679f73eb6"))], transitions=[transition])])
        self.assertEqual(frbc_system_description.message_id, uuid.UUID("97256813-de70-4640-a992-9ae0b2d8e4d1"))
        self.assertEqual(frbc_system_description.message_type, "FRBC.SystemDescription")
        self.assertEqual(frbc_system_description.storage,
                         FRBCStorageDescription(diagnostic_label="some-test-string8418",
                                                fill_level_label="some-test-string9512",
                                                fill_level_range=NumberRange(end_of_range=20876.752745956997,
                                                                             start_of_range=18324.0229135081),
                                                provides_fill_level_target_profile=False,
                                                provides_leakage_behaviour=True, provides_usage_forecast=False))
        self.assertEqual(frbc_system_description.valid_from,
                         datetime(year=2020, month=10, day=7, hour=6, minute=30, second=55,
    ...
    def test__to_json__happy_path_full(self):
        ...
        frbc_system_description = FRBCSystemDescription(actuators=[
            FRBCActuatorDescription(diagnostic_label="some-test-string2728",
                                    id=uuid.UUID("a1061148-f19e-4b1b-8fe3-b506583ce61e"), operation_modes=[
                    FRBCOperationMode(abnormal_condition_only=False, diagnostic_label="some-test-string2930", elements=[
                        FRBCOperationModeElement(fill_level_range=NumberRange(end_of_range=36932.65171036228,
                    ...
                    Timer(diagnostic_label="some-test-string4315",
                          ...
                          id=uuid.UUID("e1ff9e58-935b-4765-92e3-5e7679f73eb6"))], transitions=[transition])],
                                                        ...
                                                        storage=FRBCStorageDescription(
                                                            ...
                                                            provides_leakage_behaviour=True,
                                                            provides_usage_forecast=False),
                                                        valid_from=datetime(year=2020, month=10, day=7, hour=6,
                                                                            minute=30, second=55, tzinfo=offset(
                                                                offset=timedelta(seconds=0.0))))
