        ...
        json_str = """
{
    ...
    "leakage_rate": 1170.4041485129987
        ...
        # Assert
        self.assertEqual(frbc_leakage_behaviour_element.fill_level_range,
    ...
    def test__to_json__happy_path_full(self):
        ...
        frbc_leakage_behaviour_element = FRBCLeakageBehaviourElement(
            fill_level_range=NumberRange(end_of_range=40192.498918818455, start_of_range=29234.82582981918),
            leakage_rate=1170.4041485129987)
