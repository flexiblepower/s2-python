        ...
        json_str = """
{
    ...
    "provides_usage_forecast": false
        ...
        # Assert
        self.assertEqual(frbc_storage_description.diagnostic_label, "some-test-string3063")
        self.assertEqual(frbc_storage_description.fill_level_label, "some-test-string2323")
        self.assertEqual(frbc_storage_description.fill_level_range,
                         NumberRange(end_of_range=14555.806367871957, start_of_range=10409.397377840089))
    ...
    def test__to_json__happy_path_full(self):
        # Arrange
        frbc_storage_description = FRBCStorageDescription(diagnostic_label="some-test-string3063",
                                                          fill_level_label="some-test-string2323",
                                                          fill_level_range=NumberRange(end_of_range=14555.806367871957,
                                                                                       start_of_range=10409.397377840089),
                                                          provides_fill_level_target_profile=True,
                                                          provides_leakage_behaviour=False,
                                                          provides_usage_forecast=False)
