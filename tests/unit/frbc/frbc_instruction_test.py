        ...
        json_str = """
{
    ...
    "operation_mode_factor": 2303.58902271682
        ...
        self.assertEqual(frbc_instruction.actuator_id, uuid.UUID("db7855dd-05c4-4ba8-81e2-d10001c5bc3f"))
        self.assertEqual(frbc_instruction.execution_time,
                         datetime(year=2023, month=4, day=11, hour=16, minute=46, second=33,
                                  tzinfo=offset(offset=timedelta(seconds=3600.0))))
        self.assertEqual(frbc_instruction.id, uuid.UUID("9ffd68cd-b0e2-44a6-aded-4dce6c18247e"))
        self.assertEqual(frbc_instruction.message_id, uuid.UUID("bcb3e1da-e797-4951-86be-5e5d9136c63f"))
        self.assertEqual(frbc_instruction.message_type, "FRBC.Instruction")
        self.assertEqual(frbc_instruction.operation_mode, uuid.UUID("e7bf29a7-4ebc-49c1-a1fb-20725f450c91"))
        self.assertEqual(frbc_instruction.operation_mode_factor, 2303.58902271682)

    def test__to_json__happy_path_full(self):
        # Arrange
        frbc_instruction = FRBCInstruction(abnormal_condition=True,
                                           actuator_id=uuid.UUID("db7855dd-05c4-4ba8-81e2-d10001c5bc3f"),
                                           execution_time=datetime(year=2023, month=4, day=11, hour=16, minute=46,
                                                                   second=33,
                                                                   tzinfo=offset(offset=timedelta(seconds=3600.0))),
