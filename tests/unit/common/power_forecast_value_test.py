...
from s2wsjson.common import PowerForecastValue, CommodityQuantity
...
class PowerForecastValueTest(TestCase):
    ...
    def test__to_json__happy_path(self):
        # Arrange
        power_forecast_value = PowerForecastValue(commodity_quantity=CommodityQuantity.HEAT_TEMPERATURE,
                                                  value_lower_limit=450.3,
                                                  value_lower_95PPR=470.4,
                                                  value_lower_68PPR=480.3,
                                                  value_expected=500.2,
        ...
        # Assert
        expected_json = {"commodity_quantity": "HEAT.TEMPERATURE",
                         "value_lower_limit": 450.3,
                         "value_lower_95PPR": 470.4,
                         "value_lower_68PPR": 480.3,
                         "value_expected": 500.2,
