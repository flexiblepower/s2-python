...
class SelectControlTypeTest(TestCase):
    def test__from_json__happy_path(self):
        ...
        # Assert
        self.assertEqual(select_control_type.message_id, uuid.UUID("3bdec96b-be3b-4ba9-afa0-c4a0632cced5"))
    ...
    def test__to_json__happy_path(self):
        # Arrange
        select_control_type = SelectControlType(message_id="3bdec96b-be3b-4ba9-afa1-c4a0632cced5",
