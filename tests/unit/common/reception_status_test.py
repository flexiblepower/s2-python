...
class ReceptionStatusTest(TestCase):
    def test__from_json__happy_path(self):
        ...
        self.assertEqual(reception_status.subject_message_id, uuid.UUID("2bdec96b-be3b-4ba9-afa0-c4a0632cced5"))

    def test__to_json__happy_path(self):
        # Arrange
        reception_status = ReceptionStatus(diagnostic_label="Dagobert Duck is king!",
                                           message_type="ReceptionStatus",
        ...
        # Assert
        expected_json = {"diagnostic_label": "Dagobert Duck is king!",
                         "message_type": "ReceptionStatus",
                         "status": "OK",
                         "subject_message_id": "2bdec96b-be3b-4ba9-afa0-c4a0632cced5"}
