...
from s2wsjson.common import HandshakeResponse
...
class HandshakeResponseTest(TestCase):
    def test__from_json__happy_path(self):
        ...
        # Assert
        self.assertEqual(handshake_response.message_id, uuid.UUID('2bdec96b-be3b-4ba9-afa0-c4a0632cced3'))
    ...
    def test__to_json__happy_path(self):
        # Arrange
        handshake_response = HandshakeResponse(message_id=uuid.UUID('2bdec96b-be3b-4ba9-afa0-c4a0632cced3'),
