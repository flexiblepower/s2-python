...
class RevokeObjectTest(TestCase):
    def test__from_json__happy_path(self):
        ...
        # Assert
        self.assertEqual(revoke_object.message_id, uuid.UUID("3bdec96b-be3b-4ba9-afa0-c4a0632cced5"))
        self.assertEqual(revoke_object.object_id, uuid.UUID("3bdec96b-be3b-4ba9-afa0-c4a0632cced6"))
        self.assertEqual(revoke_object.object_type, RevokableObjects.FRBC_Instruction)

    def test__to_json__happy_path(self):
        # Arrange
        revoke_object = RevokeObject(message_id=uuid.UUID("3bdec96b-be3b-4ba9-afa0-c4a0632cced5"),
