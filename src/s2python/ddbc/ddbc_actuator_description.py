...
from s2python.generated.gen_s2 import DDBCActuatorDescription as GenDDBCActuatorDescription
...
@catch_and_convert_exceptions
class DDBCActuatorDescription(GenDDBCActuatorDescription, S2Message["DDBCActuatorDescription"]):
