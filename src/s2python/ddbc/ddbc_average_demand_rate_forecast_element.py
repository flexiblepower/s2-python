...
class DDBCAverageDemandRateForecastElement(
    ...
    duration: Duration = GenDDBCAverageDemandRateForecastElement.model_fields[
        "duration"
    ]
    demand_rate_expected: float = GenDDBCAverageDemandRateForecastElement.model_fields["demand_rate_expected"]  # type: ignore[assignment]
